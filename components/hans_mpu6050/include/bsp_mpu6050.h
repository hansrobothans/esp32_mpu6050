...
#define BSP_MPU6050_H "BSP_MPU6050_H"
...
*/
//debug=1开启调试，=0关闭调试
// if(mpu6050_debug){printf("[mpu6050_debug]:\n");}
...
=========================== 
*/
extern uint8_t mpu6050_device_address;
extern uint8_t buffer[14];
extern float quart[4];
extern float delta_t;
extern float pitch, yaw, roll;
extern int last_update,first_update,now;
